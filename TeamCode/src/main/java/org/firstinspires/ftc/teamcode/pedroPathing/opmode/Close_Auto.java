...
@Disabled
@Autonomous(name="Close_Auto", group="ABC Opmode", preselectTeleOp = "DecodeTeleop")
public class Close_Auto extends DecodeLibrary{
    ...
    public void shoot(){
        if(shooting){
            ...
            }else if(steps == .5 && shooting_time.milliseconds() > 400){
                shooting_time.reset();
                steps = 1;
                spindexer.setPower(.7);
                flippy_pos = flippy_up;
            }else if(steps == 1 && shooting_time.milliseconds() > 1400){
                steps = 2;
